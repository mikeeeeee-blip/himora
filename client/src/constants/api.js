...
export const API_ENDPOINTS = {
  ...
  ADMIN_UPDATE_TRANSACTION_STATUS: (transactionId) =>
    `${BASE_URL}/payments/admin/transactions/${transactionId}/status`,
  ADMIN_TRANSACTION_INVOICE: (transactionId) =>
    `${BASE_URL}/payments/admin/transactions/${transactionId}/invoice`,
