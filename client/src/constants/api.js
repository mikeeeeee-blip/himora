...
export const API_ENDPOINTS = {
  ...
  TRANSACTION_DETAIL: (transactionId) =>
    `${BASE_URL}/payments/merchant/transactions/${transactionId}`,
  ...
  PAYOUT_CANCEL: (payoutId) =>
    `${BASE_URL}/payments/merchant/payout/${payoutId}/cancel`,
  PAYOUT_STATUS: (payoutId) =>
    `${BASE_URL}/payments/merchant/payout/${payoutId}/status`,
  ...
  SUPERADMIN_CHANGE_PASSWORD: (userId) =>
    `${BASE_URL}/superadmin/users/${userId}/password`,

  // ============ SUPERADMIN - PAYOUTS ============
  ADMIN_PAYOUTS: `${BASE_URL}/payments/admin/payouts/all`,
  ADMIN_PAYOUT_APPROVE: (payoutId) =>
    `${BASE_URL}/payments/admin/payout/${payoutId}/approve`,
  ADMIN_PAYOUT_REJECT: (payoutId) =>
    `${BASE_URL}/payments/admin/payout/${payoutId}/reject`,
  ADMIN_PAYOUT_PROCESS: (payoutId) =>
    `${BASE_URL}/payments/admin/payout/${payoutId}/process`,
  ADMIN_PAYOUT_DETAILS: (payoutId) =>
    `${BASE_URL}/payments/admin/payout/${payoutId}/details`,
  ...
  // ============ CRYPTO WEBHOOK CONFIGURATION (Admin Auth) ============
  // Note: We send webhooks TO 3rd party, not receive from them
  // CRYPTO_WEBHOOK_URL is configured in environment variables (3rd party's endpoint)
  CRYPTO_WEBHOOK_HEALTH: `${BASE_URL}/crypto/webhook/health`,
  CRYPTO_WEBHOOK_SECRET: `${BASE_URL}/crypto/webhook/secret`,
  CRYPTO_WEBHOOK_SECRET_GENERATE: `${BASE_URL}/crypto/webhook/secret/generate`,
};
